...
//rsync --include '*/' --include '*.html' --include '*.php' --exclude '*' --recursive --progress --size-only -ptgo /webroot/prd-craftlister_com/* root@alienation.craftlister.com:/webroot/prd-craftlister_com/.
