...
$vars['DSE']['SCRIPT_VERSION_DATE']="2012/08/22";
...
//				print "\n\nu=$User s=$Sys f=$Free u=$Used rw=$RedWidth mw=$MagentaWidth gw=$GreenWidth\n";
				...
				if($Used>60){
					...
					print colorize("$Used% ","yellow","black",TRUE,1);
				}elseif($Used>10){
					print colorize("$Used% ","green","black",TRUE,1);
				}else{
					print colorize("$Used% ","cyan","black",TRUE,1);
				}
				print pad("",3-strlen($Used));
				print colorize(pad("SYS",$RedWidth,"#","left"),"red","black",TRUE,0);
				print colorize(pad("USER",$MagentaWidth,"#","center"),"magenta","black",TRUE,0);
				print colorize(pad("IDLE",$GreenWidth,"#","right"),"green","black",TRUE,0);
